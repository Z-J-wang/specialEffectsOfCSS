<template>
  <div>
            ...
            <ul>
              <li>
                <div class="port-1 effect-1">
                  <div class="image-box">
                    <img src="../assets/mti_1.jpg" alt="Image-1" />
                  </div>
                  <div class="text-desc">
                    <h3>Your Title</h3>
              ...
              <li>
                <div class="port-1 effect-2">
                  <div class="image-box">
                    <img src="../assets/mti_1.jpg" alt="Image-2" />
                  </div>
                  <div class="text-desc">
                    <h3>Your Title</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              ...
              <li>
                <div class="port-1 effect-3">
                  <div class="image-box">
                    <img src="../assets/mti_1.jpg" alt="Image-3" />
                  </div>
                  <div class="text-desc">
                    <h3>Your Title</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            ...
            <ul>
              <li>
                <div class="port-2 effect-1">
                  <div class="image-box">
                    <img src="../assets/mti_2.jpg" alt="Image-1" />
                  </div>
                  <div class="text-desc">
                    <h3>Your Title</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              ...
              <li>
                <div class="port-2 effect-2">
                  <div class="image-box">
                    <img src="../assets/mti_2.jpg" alt="Image-2" />
                  </div>
                  <div class="text-desc">
                    <h3>Your Title</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              ...
              <li>
                <div class="port-2 effect-3">
                  <div class="image-box">
                    <img src="../assets/mti_2.jpg" alt="Image-3" />
                  </div>
                  <div class="text-desc">
                    <h3>Your Title</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    ...
    <footer style="width:100%;margin-top:900px;text-align:cebter;background-color: #ffffff;">
      <p>代码：引用自《懒人之家》www.Lanrenzhijia.com</p>
    </footer>
  </div>
</template>
